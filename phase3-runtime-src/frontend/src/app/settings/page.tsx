...
import { getEvaluationReport, getModelGatewayStatus, statusTone } from "../../lib/api";

export default async function SettingsPage() {
  const [gateway, evaluation] = await Promise.all([getModelGatewayStatus(), getEvaluationReport()]);
  const rows = [
    {
